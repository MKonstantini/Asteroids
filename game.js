...
const SAVE_KEY_SCORE = "highscore"; // save key for session storage of high score
...
function destroyAsteroid(index) {
    ...
    if (score > scoreHigh) {
        scoreHigh = score;
        sessionStorage.setItem(SAVE_KEY_SCORE, scoreHigh);
    }
...
function newGame() {
    ...
    var scoreStr = sessionStorage.getItem(SAVE_KEY_SCORE);
    if (scoreStr == null) {
        scoreHigh = 0;
    } else {
